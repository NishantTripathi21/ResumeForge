...
```bash
git clone https://github.com/NishantTripathi21/ResumeForge
cd ResumeForge
```
...
```plaintext
MONGODB_URI={Your MongoDB URI} # If using Docker: mongodb://mongodb:27017/ResumeForge
PORT=5001
...
- Go to the original repository:  
  **https://github.com/NishantTripathi21/ResumeForge**
...
- [@Nishant Triapthi](https://www.linkedin.com/in/nishanttripathi21/)
